<template>
  <div class="module twoColParent">
    <div class="twoColChild">
      <p>This component includes a simple example of arduino communications using plain text. Use it with the corresponding two_way_comms sketch found in the /src/components/examples/arlduino/sketch folder.</p>
...
export default {
  ...
  async mounted() {
    ...
    if (isElectron()) {
      ...
      this.arduino = createPlainTextArduino(this.config.arduino);
